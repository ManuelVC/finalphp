    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" >PHP :: CUENTA</a>
            </div>
            <!-- /.navbar-header -->
        ...
        <div id="page-wrapper">
            ...
            <form action="cuenta.html" method="POST" role="form" style="padding-bottom: 2em">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="passactual" class="form-control" id="exampleInputEmail1" placeholder="Contraseña">
                </div>

                <div class="form-group">
                    <label for="exampleInputEmail1">Nueva Contraseña</label>
                    <input type="text" name="passnuevo" class="form-control" id="exampleInputEmail1" placeholder="Contraseña">
                </div>
